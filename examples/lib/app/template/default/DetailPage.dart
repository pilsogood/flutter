...
import 'package:examples/app/template/default/ListPage.dart';
...
class DetailPage extends StatefulWidget {
  ...
  final Db getDb;
  DetailPage({Key key, @required this.getDb}) : super(key: key);
...
class _AppStatus extends State<DetailPage> {
